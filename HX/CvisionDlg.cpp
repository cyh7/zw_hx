...
HTuple hv_min_length_width_line = edit_frame_length * 0.10;
HTuple hv_min_length_height_line = edit_frame_width * 0.10;
...
//UINT locateleft(LPVOID pParam)
{
	...
	if (hv_Area < 0.1 * (hv_Row2 - hv_Row1) * (hv_Column2 - hv_Column1))
	{
		check_l_over = 0;
		empty_location_data();
